...
<div class="tutorial">
    ...
    <div class="contents">
        <ul>
            ...
            <li>Masukkan url post Instagram Kamu.</li>
            <li>Klik "Submit" dan tunggu Like Kamu bertambah.</li>
        </ul>
        <p>
            Selesai! Sekarang, Kamu hanya perlu menunggu Like baru Kamu bertambah secara gratis. Nikmati
            pertumbuhan
