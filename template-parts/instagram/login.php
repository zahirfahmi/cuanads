<div class="card-features" id="before_submit">
    <form id="ig_login_form">
        ...
        <div class="mt-3 small">By clicking the button below, you agree to the Terms conditions.</div>
        <div class="button_wrap">
            <button type="submit" id="ig_login_btn" class="primary_btn">
                Login
            </button>
            <a class="secondary_btn" href="/buy-followers-instagram">
                Beli Followers
            </a>
        </div>
    </form>
