<div class="bot-content">
    ...
    <div class="article-info">
        <div class="below-single">
            <div class="author d-none d-lg-flex">
            ...
            <?php if (wp_is_mobile()) : ?>
                <div class="category_share">
                    <div class="category" style="width: 50%; flex: 0 0 50%;">
                        <div class="title">
                            Category
                        </div>
                    ...
                    <div class="share-widgets" style="width: 50%; flex: 0 0 50%;">
                        <div class="title">
                            <div class="share-dialog">
                                <?php $email_share = get_field('social_media', 'option');
                                ?>
                                <header>
                                ...
                                <div class="targets">
                                    ...
                                    <a href="https://twitter.com/intent/tweet?text=<?php echo get_permalink(get_the_ID()); ?>"
                                        target="_blank" rel="noopener" class="button">
                                        <svg>
                                    ...
                                    <a href="mailto:<?= $email_share['email']; ?>" target="_blank" rel="noopener"
                                        class="button">
                                        <svg>
                                            <use href="#email"></use>
                                        </svg>
                                ...
                                <div class="link">
                                    ...
                                    <button class="copy-link" type="button" onclick="copyToClipboard('#link')">Copy
                                        Link</button>
                                </div>
                            </div>

                            <button class="share-button" title="Share this article">
                                <svg>
